...
public class Maths
{
	 ...
	 * Finds the normal vector of the triangle generated by 3 edges
	 * The points are specified in a counter-clockwise order as seen from a direction opposing the normal
	 * @param a Edge A
	 * @param b Edge B
	 * @param c Edge C
	 * @return

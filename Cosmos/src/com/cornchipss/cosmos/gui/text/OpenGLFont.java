...
public class OpenGLFont
{
	...
	/**
	 * Bitmap image of each character CHAR_MIN - CHAR_MAX excluding the DEL
	 * character
	 */
	...
	/**
	 * Generates the information about the font needed to get a characters
	 * width/height
	 * 
	...
	/**
	 * <p>
	 * A way of representing a drawable font using opengl
	 * </p>
	 * <p>
	 * Use {@link OpenGLFont#bind()} to start using it, and
	 * {@link OpenGLFont#unbind()} to stop.
	 * </p>
	 * <p>
	 * This will unbind any texture currently being used
	 * </p>
	 * 
	...
	/**
	 * The font this is generated from. Changing this font after calling
	 * {@link OpenGLFont#init()} will do nothing
	 * 

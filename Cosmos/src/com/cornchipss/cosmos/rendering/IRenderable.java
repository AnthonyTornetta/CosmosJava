...
{
	/**
	 * Updates the graphics of the object - this is not guarenteed to be called before the first draw().
	...
	/**
	 * True if this object should be drawn, false if not.  The updateGraphics() method will be called no matter what

...
{
	public abstract void receiveClient(CosmosNettyClient client,
		ClientGame game);

	public abstract void receiveServer(CosmosNettyServer server,
		ServerGame game, ClientConnection c);
}
